...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU_HDL_TEAM2/verilog/LAB5/Vending Machine/Vending Machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VendingMachineFPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VendingMachineFPGA.tcl -notrace
