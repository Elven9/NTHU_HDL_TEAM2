...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU_HDL_TEAM2/verilog/LAB5/Vending Machine/Vending Machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VendingMachineFPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VendingMachineFPGA.tcl
