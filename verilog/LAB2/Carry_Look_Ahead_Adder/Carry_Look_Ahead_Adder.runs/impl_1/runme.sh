...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU_HDL_TEAM2/verilog/LAB2/Carry_Look_Ahead_Adder/Carry_Look_Ahead_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RippleCarryAdder_t.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RippleCarryAdder_t.tcl -notrace
