...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU_HDL_TEAM2/verilog/LAB2/Carry_Look_Ahead_Adder/Carry_Look_Ahead_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RippleCarryAdder_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RippleCarryAdder_t.tcl
