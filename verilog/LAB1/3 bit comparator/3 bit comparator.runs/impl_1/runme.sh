...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU-HDL-LAB1/3 bit comparator/3 bit comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_3bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comparator_3bits.tcl -notrace
