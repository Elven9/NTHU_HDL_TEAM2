...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU-HDL-LAB1/3 bit comparator/3 bit comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparator_3bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comparator_3bits.tcl
