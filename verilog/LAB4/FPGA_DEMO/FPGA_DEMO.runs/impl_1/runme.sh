...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU_HDL_TEAM2/verilog/LAB4/FPGA_DEMO/FPGA_DEMO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_TeamX_Stopwatch_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab4_TeamX_Stopwatch_fpga.tcl -notrace
