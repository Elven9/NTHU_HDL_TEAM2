...
HD_PWD='C:/Users/elven/Desktop/Hardware Design Lab/NTHU_HDL_TEAM2/verilog/LAB4/FPGA_DEMO/FPGA_DEMO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_TeamX_Stopwatch_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab4_TeamX_Stopwatch_fpga.tcl
